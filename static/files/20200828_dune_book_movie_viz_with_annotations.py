...
annotations = [
    annotate(0.09, 0.11, 0, 85, "voice-over narration<br>followed by non-canon<br>scenes with the<br>Spacing Guild"),
    annotate(0.175, 0.11, 0, 70, "weirding module<br>is introduced"),
    annotate(0.225, 0.11, 0, 110, "movie's pacing falls behind the book's<br>and catches up by the end of Part II"),
    annotate(0.345, 0.11, 0, 70, "transition scenes on House Atreides<br>departing Caladan and arriving on Arrakis"),
    annotate(0.4, 0.11, 120, 60, "spice expedition"),
    annotate(0.715, 0.11, 0, 70, "Paul trains his holy warriors<br>to use the weirding module"),
    annotate(0.935, 0.11, 0, 65, "Paul summons rain"),
    annotate(0.09, 0.89, 0, -75, "voice-over narration followed by<br>non-canon scenes of House Atreides<br>in space en-route to Arrakis"),
    annotate(0.285, 0.89, 0, -60, "dinner party"),
    annotate(0.319, 0.89, 30, -90, "movie's pacing exceeds<br>the book's from here on"),
    annotate(0.362, 0.89, 80, -65, "last scene in<br>movie Part I"),
    annotate(0.5, 0.89, 0, -75, "un-matched scenes are faithful<br>to the plot but depict events<br>that don't have page time"),
    annotate(0.643, 0.89, 0, -65, "last scene in<br>movie Part II"),
